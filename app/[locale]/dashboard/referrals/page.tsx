        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <div className="glass-strong p-8 rounded-3xl space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold">{t("membersCard.title")}</h3>
                  <p className="text-sm text-muted-foreground">{t("membersCard.subtitle")}</p>
                </div>
              </div>
              <p className="text-5xl font-black text-gradient">{memberCount}</p>
              <p className="text-sm text-muted-foreground">
                {t("membersCard.pointsEarned", { points: memberCount * 20 })}
              </p>
            </div>
            ...
            <div className="glass-strong p-8 rounded-3xl space-y-4 border-2 border-accent/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold">{t("supportersCard.title")}</h3>
                  <p className="text-sm text-muted-foreground">{t("supportersCard.subtitle")}</p>
                </div>
              </div>
              <p className="text-5xl font-black text-gradient">{supporterCount}</p>
              <p className="text-sm text-muted-foreground">
                {t("supportersCard.pointsEarned", { points: supporterCount * 10 })}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-3xl font-black">{t("invitedMembers")}</h2>
            ...
            {referredMembers && referredMembers.length > 0 ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                          <div className="flex items-center gap-2">
                            ...
                            <span>{t("joinedOn")} {new Date(member.created_at).toLocaleDateString(dateLocale)}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Trophy className="w-4 h-4" />
                            <span className="font-bold text-accent">{t("points", { count: member.points })}</span>
                          </div>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-muted-foreground">{t("youEarned")}</p>
              ...
              <div className="glass-strong p-12 rounded-3xl text-center">
                ...
                <p className="text-lg text-muted-foreground">{t("noMembersYet")}</p>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-3xl font-black">{t("invitedSupporters")}</h2>
            ...
            {referredSupporters && referredSupporters.length > 0 ? (
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                          ...
                          <div className="flex items-center gap-2">
                            <Calendar className="w-4 h-4" />
                            <span>{t("joinedOn")} {new Date(supporter.created_at).toLocaleDateString(dateLocale)}</span>
                          </div>
                        </div>
                      </div>
                      <div className="text-right">
              ...
              <div className="glass-strong p-12 rounded-3xl text-center border-2 border-accent/20">
                ...
                <p className="text-lg text-muted-foreground">{t("noSupportersYet")}</p>
                <p className="text-sm text-muted-foreground mt-2">
                  {t("noSupportersHint")}
                </p>
              </div>
