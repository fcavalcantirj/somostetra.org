        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="mb-12 space-y-6">
            <div className="inline-flex items-center gap-2 glass px-6 py-3 rounded-full">
              ...
              <span className="text-sm font-bold uppercase tracking-wider">Meus Desejos</span>
            </div>
            <h1 className="text-5xl lg:text-6xl font-black tracking-tighter">
              Seus <span className="text-gradient">Desejos</span>
            </h1>
            <p className="text-xl text-muted-foreground">
              Compartilhe suas necessidades com a comunidade
            </p>
          </div>
          ...
          {!isUnlocked ? (
            ...
            <div className="glass-strong p-12 rounded-3xl text-center space-y-6">
              ...
              <h2 className="text-2xl font-black">Complete seu perfil para desbloquear</h2>
              <p className="text-muted-foreground max-w-md mx-auto">
                Para criar desejos e receber ajuda da comunidade, você precisa completar seu perfil primeiro.
              </p>
