    ...
    <div className="space-y-6">
      ...
      <div className="glass-strong p-6 rounded-2xl">
        ...
        <div className="space-y-4">
          {/* Conditions */}
          <div>
            <Label htmlFor="conditions" className="text-muted-foreground">Condições médicas</Label>
            <Input
              id="conditions"
              value={conditions}
            ...
            <p className="text-xs text-muted-foreground mt-1">
              ...
              <span className="text-amber-600 dark:text-amber-400">Use palavras em inglês</span>
              {" "}(ex: tetraplegia, spinal cord injury)
            </p>
            <p className="text-xs text-muted-foreground/60 mt-1">
              Para fins de estudo, armazenamos as buscas realizadas.
            </p>
          </div>
          ...
          {showFilters && (
            <div className="grid md:grid-cols-2 gap-4 pt-4 border-t border-border">
              ...
              {/* Phase */}
              <div>
                <Label className="text-muted-foreground mb-2 block">Fase</Label>
                <div className="flex flex-wrap gap-2">
              ...
              {/* Location */}
              <div>
                <Label className="text-muted-foreground mb-2 block">Localização (Estado)</Label>
          ...
          <div className="flex items-center justify-between pt-4">
            ...
            >
              ...
              Apenas Brasil {filterBrazilOnly ? `(${totalCount})` : brazilTrialsCount > 0 ? `(${brazilTrialsCount})` : ""}
            </button>
            <Button
              ...
              >
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-4 text-sm">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-muted-foreground">Locais</p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-muted-foreground">Elegibilidade</p>
                      <p className="text-foreground">
