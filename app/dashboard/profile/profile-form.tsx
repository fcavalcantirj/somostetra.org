    ...
    <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {(saveResult.pointsAwarded ?? 0) > 0 && (
                <div className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-yellow-500/30 via-amber-500/30 to-orange-500/30 border border-yellow-400/50 shadow-lg shadow-yellow-500/20">
                  ...
                  <span className="font-bold text-lg bg-gradient-to-r from-yellow-200 via-amber-300 to-yellow-200 bg-clip-text text-transparent">
                    +{saveResult.pointsAwarded} pontos
                  </span>
                </div>
              )}
            </div>
      ...
      <section className="glass-strong p-6 sm:p-8 rounded-3xl">
        ...
        <div className="space-y-2">
          <Label htmlFor="username">URL do seu perfil público</Label>
          <div className="flex items-center gap-2">
            <span className="text-muted-foreground text-sm">somostetra.org/p/</span>
      ...
      <section className="glass-strong p-6 sm:p-8 rounded-3xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            <Label>Meio de Comunicação Preferido</Label>
            <div className="grid grid-cols-2 gap-2">
      ...
      {isMember && (
        <section className="glass-strong p-6 sm:p-8 rounded-3xl">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Estas informações são opcionais e nos ajudam a entender melhor a comunidade.
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">Mês e ano aproximados</p>
            </div>

            {/* Injury Level */}
            <div className="space-y-2">
              <Label htmlFor="injury_level">Nível da Lesão</Label>
              <Input
                id="injury_level"
                value={formData.injury_level}
                onChange={(e) => updateField("injury_level", e.target.value)}
                placeholder="Ex: C4, T10"
              />
            </div>

            {/* Acquired Injury */}
            <div className="space-y-2">
              <Label>Lesão Medular Adquirida</Label>
              <p className="text-xs text-muted-foreground mb-2">
                Lesão ocorrida após o nascimento (não congênita)
              </p>
            ...
            <div className="space-y-2 md:col-span-2">
              <Label>Avaliação ASIA/ISNCSCI Recente</Label>
              <p className="text-xs text-muted-foreground mb-2">
                Realizada por profissional qualificado nos últimos 6 meses
              </p>
              <div className="flex gap-4">
                <button
                  type="button"
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg glass">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Seu perfil ficará visível em somostetra.org/p/{formData.username || "seu_nome"}
              </p>
            </div>
            <button
              type="button"
